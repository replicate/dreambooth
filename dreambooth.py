...
def parse_args(input_args=None):
    ...
    parser.add_argument("--attn_only", action="store_true", help="Only train U-Net cross-attention layers")
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.instance_images_paths, self.filenames_labels = load_dataset(self.instance_data_dir)
...
class PromptDataset(Dataset):
    ...
    def __getitem__(self, index):
        example = {}
        instance_path = self.instance_images_paths[index % len(self.instance_images_paths)]
...
def main(args):
    ...
    if args.with_prior_preservation:
        ...
        if cur_class_images < args.num_class_images:
            ...
            sample_dataset = PromptDataset(args.instance_data_dir, args.num_class_images)
            ...
            for example in tqdm(
                ...
                for i, image in enumerate(images):
                    ...
                    dashed_prompt = example["prompt"][i].replace(" ", "-").replace("'", "")
                    image_filename = class_images_dir / f"{dashed_prompt}-{hash_image}.jpg"
